...
extension FileManager {
  ...
  static func tempDirectory(
    with pathComponent: String = ProcessInfo.processInfo.globallyUniqueString
  ) -> URL {
    var tempURL: URL
    ...
    if !FileManager.default.fileExists(atPath: tempURL.path) {
      do {
        try FileManager.default.createDirectory(
          at: tempURL, withIntermediateDirectories: true, attributes: nil)
      } catch {
